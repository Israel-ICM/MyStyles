...
public class UIList extends BasicListUI {
    private String COLOR_BACKGROUND = StyleColorsMetro.LIST_BACKGROUND;
    private String COLOR_ITEM_FOREGROUND = StyleColorsMetro.LIST_ITEM_FOREGROUND;
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        c.setBorder(border);*/
        list.setBorder(null);
        ((JViewport)list.getParent()).setBorder(null);
    ...
    private void installColors() {
        if (MetroUIConfigTheme.isDarkMode()) {
            COLOR_BACKGROUND = StyleColorsMetro.LIST_BACKGROUND_DARK;
            COLOR_ITEM_FOREGROUND = StyleColorsMetro.LIST_ITEM_FOREGROUND_DARK;
        }
    }
