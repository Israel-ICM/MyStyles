...
public class UITextField extends BasicTextFieldUI  {
    ...
    private String COLOR_BUTTON_ICON = StyleColorsMetro.TEXT_FIELD_BUTTON_ICON;
    ...
    private void installColors() {
        if (MetroUIConfigTheme.isDarkMode()) {
            ...
            COLOR_BUTTON_ICON = StyleColorsMetro.TEXT_FIELD_BUTTON_ICON_DARK;
    ...
    private void iconResized(String icon) {
        ...
        switch (icon) {
            case MetroUIComponent.ICON_SEARCH:
                iconOrButton.setIcon(createSearchImage(sizeButton, sizeButton, (currentStateTextField == STATE_FOCUS) ? UITools.colorToHex(MetroUIConfigTheme.getPrimaryColor()) : COLOR_BUTTON_ICON, 1));
    ...
    private void buttonClearResized() {
        ...
        iconOrButton.setLocation(textField.getWidth() - iconOrButton.getWidth() - UITools.PADDING_CONTENTS, textField.getHeight() - iconOrButton.getHeight() - UITools.PADDING_CONTENTS);
        iconOrButton.setIcon(createClearImage(sizeButton, sizeButton, (currentStateTextField == STATE_FOCUS) ? UITools.colorToHex(MetroUIConfigTheme.getPrimaryColor()) : COLOR_BUTTON_ICON, 1));
        textField.add(iconOrButton);
    }
    ...
    private void installBackground(Graphics2D g2d) {
        ...
        textField.setForeground(Color.decode(COLOR_FOREGROUND));
        textField.setCaretColor(Color.decode(COLOR_CARET));
        // textField.setCaret(new CaretMetro());
    ...
    private void installBorder() {
        switch (currentStateTextField) {
            case STATE_DEFAULT:
                textField.setBorder(new LineBorder(Color.decode(COLOR_BORDER), 2));
                break;
            case STATE_OVER:
                textField.setBorder(new LineBorder(Color.decode(UITools.bajarBrillo(COLOR_BORDER)), 2));
                break;
            case STATE_FOCUS:
