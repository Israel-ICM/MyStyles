...
public class UITabbedPane extends BasicTabbedPaneUI {
    private String COLOR_BACKGROUND_LEFT = StyleColorsMetro.TAB_COLOR_BACKGROUND;
    private String COLOR_BACKGROUND_TAB_LEFT_OVER = StyleColorsMetro.TAB_COLOR_BACKGROUND_OVER;
    private String COLOR_BACKGROUND_TAB_LEFT_PRESSED = StyleColorsMetro.TAB_COLOR_BACKGROUND_PRESSED;
    private String COLOR_FOREGROUND_TAB_LEFT = StyleColorsMetro.TAB_COLOR_FOREGROUND;
        ...
        switch (tabPane.getTabPlacement()) {
            ...
            case LEFT:
                if (MetroUIConfigTheme.isDarkMode())
                    COLOR_BACKGROUND_LEFT = StyleColorsMetro.TAB_COLOR_BACKGROUND_DARK;
    ...
    protected void paintTabBackground(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
        ...
        switch (tabPlacement) {
            ...
            case LEFT:
                if (MetroUIConfigTheme.isDarkMode()) {
                    COLOR_BACKGROUND_TAB_LEFT_OVER = StyleColorsMetro.TAB_COLOR_BACKGROUND_OVER_DARK;
                    COLOR_BACKGROUND_TAB_LEFT_PRESSED = StyleColorsMetro.TAB_COLOR_BACKGROUND_PRESSED_DARK;
                }
    ...
    protected void paintText(Graphics g, int tabPlacement, Font font, FontMetrics metrics, int tabIndex, String title, Rectangle textRect, boolean isSelected) {
        ...
        switch (tabPane.getTabPlacement()) {
            ...
            case LEFT:
                if (MetroUIConfigTheme.isDarkMode()) {
                    COLOR_FOREGROUND_TAB_LEFT = StyleColorsMetro.TAB_COLOR_FOREGROUND_DARK;
                }
