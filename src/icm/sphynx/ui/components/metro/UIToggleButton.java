 ...
 * @author israel-icm
 */
public class UIToggleButton extends BasicToggleButtonUI implements MouseListener {
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        if (btn.isSelected())
            btn.setBackground(MetroUIConfigTheme.getSecondColor());
        else
            btn.setBackground(MetroUIConfigTheme.getPrimaryColor());
